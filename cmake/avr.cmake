...
function(avr_target_generate_eeprom_hex target)
    add_custom_command(
        ...
        COMMAND ${AVR_OBJCOPY} --no-change-warnings -j .eeprom --set-section-flags=.eeprom=alloc,load --change-section-lma .eeprom=0 -O ihex $<TARGET_FILE:${target}> ${target}-eeprom.hex
        DEPENDS $<TARGET_FILE:${target}>
    )
